...
/* 350 */     Type<Either<Integer, Pair<String, String>>> ☃ = DSL.or(DSL.intType(), DSL.named(aax.q.typeName(), DSL.namespacedString()));
/* 351 */     Type<Pair<String, String>> type = DSL.named(aax.q.typeName(), DSL.namespacedString());
/* 352 */     OpticFinder<Either<Integer, Pair<String, String>>> opticFinder = DSL.fieldFinder("id", ☃);
/* 353 */     return fixTypeEverywhereTyped("ItemIdFix", getInputSchema().getType(aax.k), getOutputSchema().getType(aax.k), typed -> typed.update(☃, type, ()));
/*     */   }
/*     */ }


/* Location:              F:\dw\server.jar!\zz.class
