...
/*  35 */   private final Set<l> g = Sets.newLinkedHashSet();
/*     */   private final ij h;
/*     */   
/*     */   public l(pc ☃, @Nullable l l1, @Nullable u u1, o o1, Map<String, q> map, String[][] arrayOfString) {
/*  39 */     this.d = ☃;
/*  40 */     this.b = u1;
/*  41 */     this.e = (Map<String, q>)ImmutableMap.copyOf(map);
/*  42 */     this.a = l1;
/*  43 */     this.c = o1;
/*  44 */     this.f = arrayOfString;
/*  45 */     if (l1 != null) {
/*  46 */       l1.a(this);
/*     */     }
/*     */     
/*  49 */     if (u1 == null) {
/*  50 */       this.h = new iq(☃.toString());
/*     */     } else {
/*  52 */       ij ij1 = u1.a();
/*  53 */       a a = u1.e().c();
/*     */       
/*  55 */       ij ij2 = ij1.h().a(a).a("\n").a(u1.b());
/*  56 */       ij ij3 = ij1.h().a(ip1 -> ip1.a(new il(il.a.a, ☃)));
/*     */       
/*  58 */       this.h = (new iq("[")).a(ij3).a("]").a(a);
/*     */     } 
/*     */   }
/*     */   
/*     */   public a a() {
/*  63 */     return new a((this.a == null) ? null : this.a.h(), this.b, this.c, this.e, this.f);
/*     */   }
/*     */   
/*     */   @Nullable
/*     */   public l b() {
...
/*  82 */     return "SimpleAdvancement{id=" + 
/*  83 */       h() + ", parent=" + ((this.a == null) ? "null" : (String)this.a
/*  84 */       .h()) + ", display=" + this.b + ", rewards=" + this.c + ", criteria=" + this.e + ", requirements=" + 
/*     */ 
/*     */ 
/*     */       
/*  88 */       Arrays.deepToString((Object[])this.f) + '}';
/*     */   }
/*     */ 
/*     */   
/*     */   public Iterable<l> e() {
...
/*     */     }
/* 120 */     l l1 = (l)☃;
/* 121 */     return this.d.equals(l1.d);
/*     */   }
/*     */ 
/*     */   
/*     */   public int hashCode() {
/* 126 */     return this.d.hashCode();
/*     */   }
/*     */   
/*     */   public String[][] i() {
/* 130 */     return this.f;
