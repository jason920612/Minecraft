...
/* 110 */     return (new ToStringBuilder(this)).append("id", this.id).append("name", this.name).append("properties", this.properties).append("legacy", this.legacy).toString();
/*     */   }
/*     */   
...
/* Location:              F:\dw\server.jar!\com\mojang\authlib\GameProfile.class
